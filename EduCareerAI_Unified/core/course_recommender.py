...
def predict_top_courses(student_dict: dict, field_filter: str = None, career_field: str = None, top_n: int = 5, model_dir: str = None) -> list:
    """
    Predicts Top N recommended courses using the trained pipeline.
